                  ...
                  {comp.contacts.map(ct => {
                    ...
                    return (
                      <button
                        key={ct.id}
                        onClick={() => {
                          const canSwitch = phase === 'idle' || phase === 'precall'
